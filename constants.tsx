...
export const NEWS: NewsItem[] = [
  {
    date: "April 27, 2026",
    title: "Student Poster Presentation Award at 2026 Annual Joint Biostatistics Symposium",
    content: "I am honored to receive the Student Poster Presentation Award at the 2026 Annual Joint Biostatistics Symposium for my research. It is a great privilege to have my work recognized by the community!"
  },
  {
    date: "March 17, 2026",
    title: <>RAB Poster Award Winner at <a href="https://stat.osu.edu/news/congratulations-2026-enar-ohio-state-student-winners" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">2026 ENAR</a></>,
    content: <>I am thrilled to announce that I am the RAB Poster Award Winner at the <a href="https://stat.osu.edu/news/congratulations-2026-enar-ohio-state-student-winners" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">2026 ENAR</a> Spring Meeting for my poster titled "DeSHAPE‑α: Deconvolution of Quantile Structures of Heterogeneity, Asymmetry, and Pattern to Advance Microbial α‑Diversity Analysis".</>,
    image: "/poster.jpg"
  },
  {
    date: "March 15, 2026",
